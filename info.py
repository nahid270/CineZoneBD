...
PICS = (environ.get('PICS', 'https://envs.sh/JJj.jpg')).split()  # Sample pic
...
OWNER_UPI_ID = environ.get('OWNER_Bikash ', 'ɴᴏ ᴀᴠᴀɪʟᴀʙʟᴇ ʀɪɢʜᴛ ɴᴏᴡ')    # Owner UPI ID for payments
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', '7dc544d9253bccc3cfecc1c677f69819') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/CineZoneBDGroup') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Ctgmovies23') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+60goZWp-FpkxNzVl') # Update channel link for the bot
